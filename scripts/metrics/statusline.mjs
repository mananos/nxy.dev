...
import { colorize, fmtDuration, fmtPct, fmtTokens, fmtUsd, fmtUsdPartial, gauge, severity } from '../lib/format.mjs';
import { ensureDir, gitBranch, nxyUserDir, toNativePath } from '../lib/paths.mjs';
import { costFor, emptyUsage, totalInput } from '../lib/pricing.mjs';
 ...
 * @property {import('../lib/transcripts.mjs').IncrementalState} main
 * @property {Record<string, import('../lib/transcripts.mjs').IncrementalState>} agents
 */
 ...
 * @param {import('../lib/config.mjs').NxyConfig} cfg
 */
